      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
        <div className="flex flex-col items-center text-center lg:max-w-md lg:items-start lg:text-left">
          ...
          <div aria-hidden="true">
            <div className="flex items-center justify-center gap-2 font-heading text-2xl font-bold text-stone-900 sm:justify-start sm:text-3xl">
              <demo.goal.icon
                key={demo.iconKey}
                size={28}
                strokeWidth={2}
          ...
          <button
            type="button"
            onClick={onStart}
            className="mt-8 flex items-center gap-2 rounded-lg bg-cyan-500 px-6 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-500"
          >
            Start a goal
            <ArrowRight size={18} />
          </button>
