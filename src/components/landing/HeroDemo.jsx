  ...
  return (
    <div className="w-full max-w-sm rounded-2xl border border-emerald-900/10 bg-white p-[clamp(0.875rem,2.6dvh,1.5rem)] shadow-sm lg:max-w-md lg:p-8 xl:max-w-lg xl:p-9 2xl:max-w-xl 2xl:p-10">
      ...
      <input
        ...
        className="h-2 w-full cursor-pointer appearance-none rounded-full bg-emerald-100
          [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-emerald-600 [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:shadow-emerald-900/25 [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:duration-150
          [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:bg-emerald-600 [&::-moz-range-thumb]:shadow-md [&::-moz-range-thumb]:shadow-emerald-900/25 [&::-moz-range-thumb]:transition-transform [&::-moz-range-thumb]:duration-150
